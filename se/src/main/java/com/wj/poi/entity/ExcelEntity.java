...
public class ExcelEntity {
    ...
    /**
     * 表头时间（整体时间，label只显示不同的地方）
     */
    private String tableHeadTime;
     ...
     *  读数总量统计
     */
    private boolean isStatisticsTotal;

    /**
     * 总量的统计
     */
    private boolean statisticsTotalAll;

    public String getTableHeadTime() {
        return tableHeadTime;
    }

    public void setTableHeadTime(String tableHeadTime) {
        this.tableHeadTime = tableHeadTime;
    }


    public boolean isStatisticsTotalAll() {
        return statisticsTotalAll;
    }

    public void setStatisticsTotalAll(boolean statisticsTotalAll) {
        this.statisticsTotalAll = statisticsTotalAll;
    }
    ...
    public boolean isStatisticsTotal() {
        return isStatisticsTotal;
    }



    public void setStatisticsTotal(boolean statisticsTotal) {
        isStatisticsTotal = statisticsTotal;
    }
