...
public class ExcelImgUtil {
     ...
     * @param valueCol
     */
    public static void createSheetBarChart(XSSFSheet sheet, String chartTitle, String xName, String yName, int firstRow, int dataEndRow, int startCol, int xAxisCol, List<Integer> valueCol, boolean isStatistics, XSSFChart chart) {
        if (null == chart) {
            //根据列数创建一个画布
            int charWidth = 6;
            int charHeight = 10;
        ...
        if (isStatistics) {
            ...
            //数据1，单元格范围位置[1, 0]到[1, 6]
            values = XDDFDataSourcesFactory.fromNumericCellRange(sheet, new CellRangeAddress(firstRow, dataEndRow, valueCol.get(0), valueCol.get(0)));
        }
     ...
     * @param valueCol   结束列
     */
    public static void createSheetPieChart(XSSFSheet sheet, String chartTitle, int firstRow, int dataEndRow, int startCol, int xAxisCol, List<Integer> valueCol, boolean isStatistics, XSSFChart chart) {
        if (null == chart) {
            //根据列数创建一个画布
            int charWidth = 6;
            int charHeight = 10;
     ...
     * @param valueCol   条数
     */
    public static void createSheetLineChart(XSSFSheet sheet, String chartTitle, List<String> lineName, String xName, String yName, int firstRow, int dataEndRow, int startCol, int xAxisCol, List<Integer> valueCol, XSSFChart chart) {
        if (null == chart) {
            //根据列数创建一个画布
            int maxCol = 9;
            int charWidth = 6;
     ...
     * @return chart对象
     */
    public static XSSFChart getSheetDrawing(XSSFSheet sheet, String chartTitle, int startCol, int firstRowOffset, int endRowOffset, int startColOffset, int endColOffset) {
        //创建一个画布
